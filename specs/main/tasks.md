...
- [X] T035 [P] Verify `.gitignore` excludes `.github/` agent dir, all log artifacts, caches, and build artifacts; confirm no credentials are tracked (security note from spec-kit init).
